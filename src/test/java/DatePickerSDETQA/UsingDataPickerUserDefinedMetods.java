...
public class UsingDataPickerUserDefinedMetods {
	...
	public static void main(String[] args)
	{
		...
		userDefined(driver, expectedYear,expectedMonth, expectedDate);
	}
	
	public static void userDefined(WebDriver driver, String expectedYear, String expectedMonth, String expectedDate)
	{
